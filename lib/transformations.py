...
# Converts a dataframe into a triplet of columns
...
# Gets party dataframe and packages all the fields into triplets
...
# Gets party address dataframe and packages all the fields into triplets
def get_address(df):
